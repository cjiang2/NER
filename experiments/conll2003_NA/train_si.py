...
config = {
    ...
    'save_dir': os.path.join(ROOT_DIR, 'checkpoints', 'NER_conll2003_na_si'),
...
if __name__ == "__main__":
    ...
    for exp_i, task in enumerate(exps):
        ...
        # Optimizer no longer reinitialized for every task
        ...
        for task_idx in range(2):
            ...
            # ####################
            # Train
            trainer.train(train_loader, [valid_loader], task_idx)
